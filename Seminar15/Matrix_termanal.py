...
'''
Запуск в терминале:
# python Seminar15/HW15/Matrix_terminal.py
# python Seminar15/HW15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253'
# python Seminar15/HW15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='='
# python Seminar15/HW15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='*'
'''